    ...
    while True:
        ...
        if faces is ():
            ...
            if (Course == " BSc " and Semester == "1"):  # ****************** checking the student cousre to save in that folder --------------------
                ...
                for (x, y, w, h) in faces:
                    count += 1
                    file_path = "C:/Users/harsh/Documents/capstone/FACE DETECTION/BSc Sem 1/" + str(Fname) + str(count) + "." + str(Eno) + ".jpg"
                ...
                for (x, y, w, h) in faces:
                    count += 1
                    file_path = "C:/Users/harsh/Documents/capstone/FACE DETECTION/BSc Sem 2/" + str(Fname) + str(count) + "." + str(Eno) + ".jpg"
                    cv2.imwrite(file_path, face)
                    cv2.rectangle(frame, (x, y), (x + w, y + h), (255, 0, 0), 2)
                ...
                for (x, y, w, h) in faces:
                    count += 1
                    file_path = "C:/Users/harsh/Documents/capstone/FACE DETECTION/BSc Sem 3/" + str(Fname) + str(count) + "." + str(Eno) + ".jpg"
                    cv2.imwrite(file_path, face)
                    cv2.rectangle(frame, (x, y), (x + w, y + h), (255, 0, 0), 2)
                ...
                for (x, y, w, h) in faces:
                    count += 1
                    file_path = "C:/Users/harsh/Documents/capstone/FACE DETECTION/BSc Sem 4/" + str(Fname) + str(count) + "." + str(Eno) + ".jpg"
                    cv2.imwrite(file_path, face)
                    cv2.rectangle(frame, (x, y), (x + w, y + h), (255, 0, 0), 2)
                ...
                for (x, y, w, h) in faces:
                    count += 1
                    file_path = "C:/Users/harsh/Documents/capstone/FACE DETECTION/BSc Sem 5/" + str(Fname) + str(count) + "." + str(Eno) + ".jpg"
                    cv2.imwrite(file_path, face)
                    cv2.rectangle(frame, (x, y), (x + w, y + h), (255, 0, 0), 2)
                ...
                for (x, y, w, h) in faces:
                    count += 1
                    file_path = "C:/Users/harsh/Documents/capstone/FACE DETECTION/BSc Sem 6/" + str(Fname + "." + Eno) + "." + str(count) + ".jpg"
                    cv2.imwrite(file_path, face)
                    cv2.rectangle(frame, (x, y), (x + w, y + h), (255, 0, 0), 2)
